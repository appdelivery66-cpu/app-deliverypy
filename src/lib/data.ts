...
export interface StoreConfig {
    ...
    cashierStatus?: { isOpen: boolean; openingTime: string; initialBalance: number; currentBalance: number };
}
...
export const INITIAL_DATA = {
    store: {
        ...
        deliveryFees: [
            ...
            { id: "2", name: "Barrio Ejemplo 1", fee: 7.00 },
            { id: "3", name: "Barrio Ejemplo 2", fee: 10.00 }
        ],
        deliveryTime: "40-60 min",
        reviewLink: "https://g.page/sua-loja/review"
    },
    categories: [
        { id: "1", name: "Hamburguesas", icon: "Pizza" },
